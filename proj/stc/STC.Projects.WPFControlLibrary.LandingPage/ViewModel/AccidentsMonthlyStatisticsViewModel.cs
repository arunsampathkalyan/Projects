...
{
    class AccidentsMonthlyStatisticsViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public Int32 FromMonthValue
        {
            ...
            set
            {
                if (_fromMonthValue != value)
                {
                    ...
                    if (ToMonthValue != _fromMonthValue)
                    {
        ...
        public int YearValue
        {
            ...
            set
            {
                ...
                {
                    _yearValue = value;
                    if (FromMonthValue > 0 && ToMonthValue > 0 && ToMonthValue != FromMonthValue)
                    {
                        GetAccidentsRegionComparisionStatisticsData();
                    }
                    this.RaiseNotifyPropertyChanged();
        ...
        public AccidentsMonthlyStatisticsViewModel()
        {
        ...
        {
            var callTask = client.GetIncidentsComparisonMonthlyAsync(YearValue, (ServiceLayerReference.MonthOfYear)FromMonthValue + 1, (ServiceLayerReference.MonthOfYear)ToMonthValue + 1);
            //var callTask = client.GetIncidentsRegionComparisonMonthlyAsync(YearValue, (ServiceLayerReference.MonthOfYear)FromMonthValue + 1, (ServiceLayerReference.MonthOfYear)ToMonthValue + 1);
