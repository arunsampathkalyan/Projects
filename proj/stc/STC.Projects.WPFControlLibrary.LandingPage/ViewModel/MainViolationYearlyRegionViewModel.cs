...
{
    class MainViolationYearlyRegionViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public MainViolationYearlyRegionViewModel()
        {
            ...
            GetMainViolationsData();
        }


        private void GetMainViolationsData()
        {
            //Compare current and previous year.
            var callTask = client.GetViolationsRegionComparisonYearlyAsync(DateTime.Now.Year - 1, DateTime.Now.Year);
