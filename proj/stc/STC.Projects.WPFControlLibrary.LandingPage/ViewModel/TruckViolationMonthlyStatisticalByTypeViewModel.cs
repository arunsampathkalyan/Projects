...
{
    class TruckViolationMonthlyStatisticalByTypeViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        #region Constractors
        public TruckViolationMonthlyStatisticalByTypeViewModel()
        {
            LoadBasicData();
        ...
        {
            var callTask = client.GetTruckViolationsStaticsticalMonthlyAsync(YearValue);
