...
{
    class DangerViolationWeeklyStatisticalByTypeViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        #region Constractors
        public DangerViolationWeeklyStatisticalByTypeViewModel()
        {
            LoadBasicData();
        ...
        {
            var callTask = client.GetDangerousViolationsStaticsticalWeeklyAsync(YearValue, (ServiceLayerReference.MonthOfYear)(MonthValue + 1));
