...
{
    class TruckViolationYearlyComparisonStatisticsViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public TruckViolationYearlyComparisonStatisticsViewModel()
        {
        ...
        public void GetViolationData()
        {
            ...
            var callTask = client.GetTruckViolationsComparisonYearlyAsync(FromYearValue, ToYearValue);
