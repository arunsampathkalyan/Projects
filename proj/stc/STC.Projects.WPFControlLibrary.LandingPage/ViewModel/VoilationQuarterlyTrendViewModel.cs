...
{
    class VoilationQuarterlyTrendViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public Int32 FromYearValue
        {
            ...
            set
            {
                if (_fromYearValue != value)
                {
                    ...
                    {
                        GetViolationTypeTrendQuarterOfYearAsync();
                    }
        ...
        public VoilationQuarterlyTrendViewModel()
        {
        ...
        public void GetViolationTypeTrendQuarterOfYearAsync()
        {
