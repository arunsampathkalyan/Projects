...
{
    class AccidentsQuarterlyTrendViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public Int32 ToYearValue
        {
            ...
            set
            {
                if (_toYearValue != value)
                {
                    ...
                    {
                        GetIncidentTrendQuarterOfYearAsync();
                    }
        ...
        public AccidentsQuarterlyTrendViewModel()
        {
        ...
        public void GetIncidentTrendQuarterOfYearAsync()
        {
            var callTask = client.GetIncidentTrendQuarterOfYearAsync(FromYearValue, ToYearValue);
