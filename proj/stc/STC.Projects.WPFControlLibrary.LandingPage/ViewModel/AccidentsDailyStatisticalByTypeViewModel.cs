...
{
    class AccidentsDailyStatisticalByTypeViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        #region Constractors
        public AccidentsDailyStatisticalByTypeViewModel()
        {
            LoadBasicData();
            GetAccidentsData();
        }
        ...
        {
            var callTask = client.GetIncidentsStatisticalDailyAsync(weekDayDateTimeDictObj.Keys.ElementAt(ToWeekStartValue));
