...
{
    class AccidentsMonthlyStatisticalByTypeViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        #region Constractors
        public AccidentsMonthlyStatisticalByTypeViewModel()
        {
            LoadBasicData();
        ...
        {
            var callTask = client.GetIncidentsStaticsticalMonthlyAsync(YearValue);
