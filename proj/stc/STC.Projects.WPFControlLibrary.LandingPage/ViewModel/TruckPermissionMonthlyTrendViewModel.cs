...
{
    class TruckPermissionMonthlyTrendViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public Int32 ToYearValue
        {
            ...
            set
            {
                if (_toYearValue != value)
                {
                    ...
                    {
                        GetViolationTypeTrendMonthOfYearAsync();
                    }
        ...
        public TruckPermissionMonthlyTrendViewModel()
        {
        ...
        public void GetViolationTypeTrendMonthOfYearAsync()
        {
            var callTask = client.GetTruckViolationsTrendMonthOfYearAsync(FromYearValue, ToYearValue);
