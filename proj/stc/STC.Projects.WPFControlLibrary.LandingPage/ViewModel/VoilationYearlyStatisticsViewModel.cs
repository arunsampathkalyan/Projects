...
{
    class VoilationYearlyStatisticsViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public Int32 FromYearValue
        {
            ...
            set
            {
                if (_fromYearValue != value)
                {
                    ...
                    {
                        GetViolationsRegionWiseYearlyAsync();
                    }
        ...
        public VoilationYearlyStatisticsViewModel()
        {
        ...
        public void GetViolationsRegionWiseYearlyAsync()
        {
            //var callTask = client.GetViolationTypeTrendQuarterOfYearAsync(FromYearValue, ToYearValue);
            var callTask = client.GetViolationsRegionComparisonYearlyAsync(FromYearValue, ToYearValue);
