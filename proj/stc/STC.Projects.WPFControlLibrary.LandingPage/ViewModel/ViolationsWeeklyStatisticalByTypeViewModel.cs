...
{
    class ViolationsWeeklyStatisticalByTypeViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        #region Constractors
        public ViolationsWeeklyStatisticalByTypeViewModel()
        {
            LoadBasicData();
        ...
        {
            var callTask = client.GetViolationsStaticsticalWeeklyAsync(YearValue, (ServiceLayerReference.MonthOfYear)(MonthValue + 1));
