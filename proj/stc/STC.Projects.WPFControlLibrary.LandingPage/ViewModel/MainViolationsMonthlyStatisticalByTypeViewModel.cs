...
{
    class MainViolationsMonthlyStatisticalByTypeViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        #region Constractors
        public MainViolationsMonthlyStatisticalByTypeViewModel()
        {
        ...
        {
            var callTask = client.GetViolationsStaticsticalMonthlyAsync(ToYearValue);
