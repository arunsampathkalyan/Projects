...
{
    class AccidentsDailyStatisticsViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public AccidentsDailyStatisticsViewModel()
        {
        ...
        {
            var callTask = client.GetIncidentsComparisonDailyAsync(dateTimeColl[FromDateValue], dateTimeColl[ToDateValue]);
            //var callTask = client.GetIncidentsRegionComparisonDailyAsync(dateTimeColl[FromDateValue], dateTimeColl[ToDateValue]);
