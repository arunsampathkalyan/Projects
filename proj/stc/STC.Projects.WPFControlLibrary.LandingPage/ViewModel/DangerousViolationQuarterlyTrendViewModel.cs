...
{
    class DangerousViolationQuarterlyTrendViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public Int32 ToYearValue
        {
            ...
            set
            {
                if (_toYearValue != value)
                {
                    ...
                    {
                        GetDangerousViolationTrendQuarterOfYearAsync();
                    }
        ...
        public DangerousViolationQuarterlyTrendViewModel()
        {
        ...
        public void GetDangerousViolationTrendQuarterOfYearAsync()
        {
            var callTask = client.GetDangerousViolationTrendQuarterOfYearAsync(FromYearValue, ToYearValue);
