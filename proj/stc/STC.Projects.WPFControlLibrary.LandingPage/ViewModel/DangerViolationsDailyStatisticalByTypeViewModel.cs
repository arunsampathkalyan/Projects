...
{
    class DangerViolationsDailyStatisticalByTypeViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        #region Constractors
        public DangerViolationsDailyStatisticalByTypeViewModel()
        {
            LoadBasicData();
            GetDangerousViolationsData();
        }
        ...
        {
            var callTask = client.GetDangerousViolationsStatisticalDailyAsync(weekDayDateTimeDictObj.Keys.ElementAt(ToWeekStartValue));
