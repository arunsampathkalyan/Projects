...
{
    class ViolationWeeklyStatisticsViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public Int32 FromWeekStartValue
        {
            ...
            set
            {
                ...
                if (_fromWeekNum != -1 && _toWeekNum != -1 && _toWeekNum != _fromWeekNum)
                    GetViolationsRegionWiseWeeklyAsync();
        ...
        public ViolationWeeklyStatisticsViewModel()
        {
        ...
        public void GetViolationsRegionWiseWeeklyAsync()
        {
            //var callTask = client.GetViolationTypeTrendWeekOfYearAsync(FromYearValue, ToYearValue);



            var callTask = client.GetViolationsRegionComparisonWeeklyAsync(weekDayDateTimeDictObj.Keys.ElementAt(FromWeekStartValue), weekDayDateTimeDictObj.Keys.ElementAt(ToWeekStartValue));
