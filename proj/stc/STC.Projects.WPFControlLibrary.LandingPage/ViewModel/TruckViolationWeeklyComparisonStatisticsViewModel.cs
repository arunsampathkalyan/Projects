...
{
    class TruckViolationWeeklyComparisonStatisticsViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public TruckViolationWeeklyComparisonStatisticsViewModel()
        {
        ...
        public void GetViolationData()
        {
            ...
            var callTask = client.GetTruckViolationsComparisonWeeklyAsync(weekDayDateTimeDictObj.Keys.ElementAt(FromWeekStartValue), weekDayDateTimeDictObj.Keys.ElementAt(ToWeekStartValue));
