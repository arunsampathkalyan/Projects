...
{
    class AccidentsWeeklyStatisticalByTypeViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        #region Constractors
        public AccidentsWeeklyStatisticalByTypeViewModel()
        {
            LoadBasicData();
        ...
        {
            var callTask = client.GetIncidentsStaticsticalWeeklyAsync(YearValue, (ServiceLayerReference.MonthOfYear)(MonthValue + 1));
