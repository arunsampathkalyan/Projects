...
{
    class AccidentsWeeklyTrendViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public Int32 ToYearValue
        {
            ...
            set
            {
                if (_toYearValue != value)
                {
                    ...
                    {
                        GetIncidentTrendWeekOfYearAsync();
                    }
        ...
        public AccidentsWeeklyTrendViewModel()
        {
        ...
        public void GetIncidentTrendWeekOfYearAsync()
        {
            var callTask = client.GetIncidentTrendWeekOfYearAsync(FromYearValue, ToYearValue);
