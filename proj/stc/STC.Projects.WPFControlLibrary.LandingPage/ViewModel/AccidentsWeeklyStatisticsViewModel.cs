...
{
    class AccidentsWeeklyStatisticsViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public AccidentsWeeklyStatisticsViewModel()
        {
        ...
        {
            var callTask = client.GetIncidentsComparisonWeeklyAsync(weekDayDateTimeDictObj.Keys.ElementAt(FromWeekStartValue), weekDayDateTimeDictObj.Keys.ElementAt(ToWeekStartValue));
            //var callTask = client.GetIncidentsRegionComparisonWeeklyAsync(weekDayDateTimeDictObj.Keys.ElementAt(FromWeekStartValue), weekDayDateTimeDictObj.Keys.ElementAt(ToWeekStartValue));
