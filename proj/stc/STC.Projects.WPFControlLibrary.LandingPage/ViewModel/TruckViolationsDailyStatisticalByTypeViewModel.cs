...
{
    class TruckViolationsDailyStatisticalByTypeViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        #region Constractors
        public TruckViolationsDailyStatisticalByTypeViewModel()
        {
            LoadBasicData();
            GetTruckViolationsData();
        }
        ...
        {
            var callTask = client.GetTruckViolationsStatisticalDailyAsync(weekDayDateTimeDictObj.Keys.ElementAt(ToWeekStartValue));
