...
{
    class AccidentsYearlyStatisticsViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public AccidentsYearlyStatisticsViewModel()
        {
        ...
        {
            var callTask = client.GetIncidentsComparisonYearlyAsync(FromYearValue, ToYearValue);
            //var callTask = client.GetIncidentsRegionComparisonYearlyAsync(FromYearValue, ToYearValue);
