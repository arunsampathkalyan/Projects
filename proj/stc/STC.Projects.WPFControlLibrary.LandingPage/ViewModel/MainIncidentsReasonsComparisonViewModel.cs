...
{
    class MainIncidentsReasonsComparisonViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        private int startDate = DateTime.Now.Year - 1;

        private int endDate = DateTime.Now.Year;
        ...
        #region Constractors
        public MainIncidentsReasonsComparisonViewModel()
        {
