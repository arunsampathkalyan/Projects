...
{
    class TruckPermissionQuarterlyTrendViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public TruckPermissionQuarterlyTrendViewModel()
        {
        ...
        {
            var callTask = client.GetTruckViolationsTrendQuarterOfYearAsync(FromYearValue, ToYearValue);
