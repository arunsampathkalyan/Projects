...
{
    class DangerousViolationYearlyStatisticsViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public Int32 ToYearValue
        {
            ...
            set
            {
                if (_toYearValue != value)
                {
                    ...
                    {
                        GetDangerousViolationRegionWiseYearlyAsync();
                    }
        ...
        public DangerousViolationYearlyStatisticsViewModel()
        {
        ...
        public void GetDangerousViolationRegionWiseYearlyAsync()
        {
            //var callTask = client.GetViolationTypeTrendQuarterOfYearAsync(FromYearValue, ToYearValue);
            var callTask = client.GetDangerousViolationsComparisonYearlyAsync(FromYearValue, ToYearValue);
