...
{
    class DangerousViolationMonthlyTrendViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public Int32 ToYearValue
        {
            ...
            set
            {
                if (_toYearValue != value)
                {
                    ...
                    {
                        GetDangerousViolationTrendMonthOfYearAsync();
                    }
        ...
        public DangerousViolationMonthlyTrendViewModel()
        {
        ...
        public void GetDangerousViolationTrendMonthOfYearAsync()
        {
            var callTask = client.GetDangerousViolationTrendMonthOfYearAsync(FromYearValue, ToYearValue);
