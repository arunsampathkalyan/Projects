...
{
    class TruckViolationMonthlyComparisonStatisticsViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public TruckViolationMonthlyComparisonStatisticsViewModel()
        {
        ...
        public void GetViolationData()
        {
            ...
            var callTask = client.GetTruckViolationsComparisonMonthlyAsync(YearValue, (ServiceLayerReference.MonthOfYear)FromMonthValue + 1, (ServiceLayerReference.MonthOfYear)ToMonthValue + 1);
