...
{
    class AccidentsMonthlyTrendViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public Int32 ToYearValue
        {
            ...
            set
            {
                if (_toYearValue != value)
                {
                    ...
                    {
                        GetIncidentTrendMonthOfYearAsync();
                    }
        ...
        public AccidentsMonthlyTrendViewModel()
        {
        ...
        public void GetIncidentTrendMonthOfYearAsync()
        {
            var callTask = client.GetIncidentTrendMonthOfYearAsync(FromYearValue, ToYearValue);
