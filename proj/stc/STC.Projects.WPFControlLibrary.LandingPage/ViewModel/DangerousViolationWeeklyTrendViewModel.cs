...
{
    class DangerousViolationWeeklyTrendViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public Int32 ToYearValue
        {
            ...
            set
            {
                if (_toYearValue != value)
                {
                    ...
                    {
                        GetDangerousViolationTrendWeekOfYearAsync();
                    }
        ...
        private void CalculateHighestValue()
        {
            ...
            foreach (var violation in ViolationsCollection)
            {
                ...
                {
                    highQuarter = highQuarter.Replace("Week", "W").Replace(" ", "");
        ...
        public DangerousViolationWeeklyTrendViewModel()
        {
        ...
        public void GetDangerousViolationTrendWeekOfYearAsync()
        {
            var callTask = client.GetDangerousViolationTrendWeekOfYearAsync(FromYearValue, ToYearValue);
