...
{
    class ViolationMonthlyStatisticsViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public Int32 FromMonthValue
        {
            ...
            set
            {
                if (_fromMonthValue != value)
                {
                    ...
                    if (_toMonthValue != _fromMonthValue)
                    {
                        GetViolationsRegionWiseMonthlyAsync();
                    }
        ...
        public ViolationMonthlyStatisticsViewModel()
        {
        ...
        public void GetViolationsRegionWiseMonthlyAsync()
        {
            var callTask = client.GetViolationsRegionComparisonMonthlyAsync(YearValue, (ServiceLayerReference.MonthOfYear)FromMonthValue + 1, (ServiceLayerReference.MonthOfYear)ToMonthValue + 1);
